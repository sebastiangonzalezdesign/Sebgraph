export const Solve = [
  {
    ...
    goal1:
      "Develop a website that invite the students to present their own projects.",
    goal2:
      "Communicate clearly to students and teachers how the contest works.",
    goal3:
      "Provide useful information and tools for a successful production of their projects.",
...
export const AV = [
  {
    ...
    goal3:
      "Provide technical information about the different products and releases.",
    goal4:
      "Create the selling tips section that allow the promoter to reinforce the sales speech.",
...
export const Essilor = [
  {
    ...
    goal4:
      "Design an interface consistent with the brand and with friendly visuals and with microinteractions.",
...
export const Landing = [
  {
    ...
    goal3:
      "Create a 360 experience for the launching models and the possibility to compare them.",
