        ...
        <section key={dataPortfolio.id} className="modal__container">
          ...
          <section className="modal__project-info">
            <article className="project-info__container">
              <img
                ...
                src="https://sebgraph.co/images/projects/av/project.png"
                loading="lazy"
          ...
          <section className="modal__template">
            ...
            <picture className="modal__img-container">
              <source
                srcSet="https://sebgraph.co/images/projects/av/user-persona-responsive.png"
                media="(max-width:900px)"
              />
              <img
                className="modal__img-complete"
                src="https://sebgraph.co/images/projects/av/user-persona.png"
                loading="lazy"
                alt="ideate"
              />
            </picture>
          ...
          <section className="modal__template">
            ...
            <picture className="modal__img-container">
              <source
                srcSet="https://sebgraph.co/images/projects/av/user-flow.png"
                media="(max-width:900px)"
              />
              <img
                className="modal__img-complete"
                src="https://sebgraph.co/images/projects/av/user-flow.png"
                loading="lazy"
                alt="ideate"
              />
            </picture>
          ...
          <section className="modal__template">
            ...
            <article className="modal__text-box">
              ...
              <picture className="modal__img-container">
                <source
                  srcSet="https://sebgraph.co/images/projects/av/mid-fidelity.png"
                  media="(max-width:900px)"
                />
                <img
                  className="modal__img-complete"
                  src="https://sebgraph.co/images/projects/av/mid-fidelity.png"
                  loading="lazy"
                  alt="ideate"
                />
              </picture>
            ...
            <article className="modal__text-box">
              ...
              <picture className="modal__img-container">
                <source
                  srcSet="https://sebgraph.co/images/projects/av/high-fidelity.png"
                  media="(max-width:900px)"
                />
                <img
                  className="modal__img-complete"
                  src="https://sebgraph.co/images/projects/av/high-fidelity.png"
                  loading="lazy"
                  alt="ideate"
                />
              </picture>
          ...
          <section className="modal__template">
            ...
            <picture className="modal__img-container mb-20">
              <source
                srcSet="https://sebgraph.co/images/projects/av/brand.png"
                media="(max-width:900px)"
              />
              <img
                className="modal__img-complete"
                src="https://sebgraph.co/images/projects/av/brand.png"
                loading="lazy"
                alt="ideate"
              />
            </picture>
            ...
            <picture className="modal__img-container mb-20">
              <source
                srcSet="https://sebgraph.co/images/projects/av/colors.png"
                media="(max-width:900px)"
              />
              <img
                className="modal__img-complete"
                src="https://sebgraph.co/images/projects/av/colors.png"
                loading="lazy"
                alt="ideate"
              />
            </picture>
            ...
            <picture className="modal__img-container mb-20">
              <source
                srcSet="https://sebgraph.co/images/projects/av/tipography.png"
                media="(max-width:900px)"
              />
              <img
                className="modal__img-complete"
                src="https://sebgraph.co/images/projects/av/tipography.png"
                loading="lazy"
                alt="ideate"
              />
            </picture>
            ...
            <picture className="modal__img-container-dark mb-20">
              <source
                srcSet="https://sebgraph.co/images/projects/av/imagery.png"
                media="(max-width:900px)"
              />
              <img
                className="modal__img-complete"
                src="https://sebgraph.co/images/projects/av/imagery.png"
                loading="lazy"
                alt="ideate"
              />
            </picture>
            ...
            <picture className="modal__img-container-dark mb-20">
              <source
                srcSet="https://sebgraph.co/images/projects/av/components.png"
                media="(max-width:900px)"
              />
              <img
                className="modal__img-complete"
                src="https://sebgraph.co/images/projects/av/components.png"
                loading="lazy"
                alt="ideate"
              />
            </picture>
            <picture className="modal__img-container-dark mb-20">
              <source
                srcSet="https://sebgraph.co/images/projects/av/cards.png"
                media="(max-width:900px)"
              />
              <img
                className="modal__img-complete"
                src="https://sebgraph.co/images/projects/av/cards.png"
                loading="lazy"
                alt="ideate"
              />
            </picture>
            <picture className="modal__img-container-dark mb-20">
              <source
                srcSet="https://sebgraph.co/images/projects/av/icons.png"
                media="(max-width:900px)"
              />
              <img
                className="modal__img-complete"
                src="https://sebgraph.co/images/projects/av/icons.png"
                loading="lazy"
                alt="ideate"
              />
            </picture>
          ...
          <section className="modal__template">
            ...
            <article className="animation-container">
              <figure className="animation-box">
                <div ref={container1} className="animation-dark"></div>
              </figure>

              <figure className="animation-box">
                <div ref={container2} className="animation-dark"></div>
              </figure>

              <figure className="animation-box">
                <div ref={container3} className="animation-dark"></div>
              </figure>
            </article>
          </section>
          ...
          <section className="modal__template">
            ...
            <picture className="modal__img-container mb-20">
              <source
                srcSet="https://sebgraph.co/images/projects/av/final-design.png"
                media="(max-width:900px)"
              />
              <img
                className="modal__img-complete"
                src="https://sebgraph.co/images/projects/av/final-design.png"
                loading="lazy"
                alt="ideate"
              />
            </picture>
            ...
            <picture className="modal__img-container mb-20">
              <source
                srcSet="https://sebgraph.co/images/projects/av/keywords.png"
                media="(max-width:900px)"
              />
              <img
                className="modal__img-complete"
                src="https://sebgraph.co/images/projects/av/keywords.png"
                loading="lazy"
                alt="ideate"
              />
            </picture>
            ...
            <picture className="modal__img-container mb-20">
              <source
                srcSet="https://sebgraph.co/images/projects/av/advanced-search.png"
                media="(max-width:900px)"
              />
              <img
                className="modal__img-complete"
                src="https://sebgraph.co/images/projects/av/advanced-search.png"
                loading="lazy"
                alt="ideate"
              />
            </picture>
            ...
            <picture className="modal__img-container mb-20">
              <source
                srcSet="https://sebgraph.co/images/projects/av/product-library.png"
                media="(max-width:900px)"
              />
              <img
                className="modal__img-complete"
                src="https://sebgraph.co/images/projects/av/product-library.png"
                loading="lazy"
                alt="ideate"
              />
            </picture>
          ...
          <picture>
            <source
              srcSet="https://sebgraph.co/images/projects/av/final-img.png"
              media="(max-width:900px)"
            />
            <img
              className="modal__img-complete"
              src="https://sebgraph.co/images/projects/av/final-img.png"
              loading="lazy"
              alt="prototyping"
            />
          </picture>
